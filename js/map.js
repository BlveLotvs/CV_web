...
var formations = [
    ...
    { coords: [43.2159, 2.3525], nom: "IUT de Carcassonne - Licence Pro SIG WEB", desc: "2022-2023", color: "blue" },
    { coords: [45.7500, 4.8550], nom: "Université Lyon 3 - Licence Géographie", desc: "2019-2022", color: "blue" },
    { coords: [45.7640, 4.8357], nom: "Lycée Edouard Herriot - Bac ES", desc: "2017-2019", color: "blue" }
];

var experiences = [
    { coords: [48.8544, 2.7824], nom: "Groupe SAUR", desc: "Géomaticien - 2023-2025", color: "red" },
    { coords: [48.8924, 2.2166], nom: "Veolia Eau d'Ile de France", desc: "Technicien SIG - 2022-2023", color: "red" },
